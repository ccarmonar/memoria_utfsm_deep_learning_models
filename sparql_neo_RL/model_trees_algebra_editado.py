...
from featurize_editado import SPARQLTreeFeaturizer
from early_stopping import EarlyStopping
from net_editado import Autoencoder, NeoNet
...
class NeoRegression:
    def __init__(self,
        ...
        print("USANDO VERSION model_trees_algebra_editado.py")
    ...
    def fit(self, X, X_query, y, X_val, X_val_query, y_val):
        ...
        print("OPTIMIZADO A UTILIZAR: ", optimizer)
