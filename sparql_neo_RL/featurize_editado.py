...
class SparqlTreeBuilder:
    def __init__(self, preds_map, preds_to_index):
        print("USANDO VERSION featurize_editado.py --- SparqlTreeBuilder")
...
class SPARQLTreeFeaturizer:
    def __init__(self):
        print("USANDO VERSION featurize_editado.py --- SPARQLTreeFeaturizer")
    ...
    def transform(self, trees):
        #print("SPARQLTreeFeaturizer, transform method active")
        # Select first tree
